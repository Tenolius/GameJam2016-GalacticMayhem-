...
public class Credits : MonoBehaviour {
    ...
    public bool changeScenes;                                           //If true, load a new scene when Credits is pressed, if false, fade out UI and continue in single scene
    ...
    public void GoToCredits()
    {
        ...
        Debug.Log("Now in Credits. Put your credits here.");
